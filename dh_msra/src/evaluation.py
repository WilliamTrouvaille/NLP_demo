...
class ModelEvaluator:
    ...
    def plot_confusion_matrix(self, true_labels, pred_labels):
        ...
        plt.close()
        logger.info("混淆矩阵已保存至 docs/confusion_matrix.png")

    def plot_loss_curve(self):
        """绘制损失曲线"""
        logger.info("绘制损失曲线...")
        with open("logs/training_loss.log", "r") as f:
            lines = f.readlines()
        ...
        plt.close()
        logger.info("损失曲线已保存至 docs/loss_curve.png")


def main():
    try:
        logger.info("启动模型评估任务...")
        model_path = "models/macbert-ner-epoch1-20250404_230129.bin"
